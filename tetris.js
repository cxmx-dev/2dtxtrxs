// Cache busting: 2025-07-21-2 force redeploy to fix init() error on GitHub Pages
class Tetris {
    constructor() {
    ...
    draw() {
        ...
        // Playfield border strobe/glow effect
        const now = Date.now();
    ...
    setupEventListeners() {
        ...
        // --- Mobile swipe up and double tap for rotate ---
        if (this.isMobile) {
            let lastTap = 0;
            let startY = 0;
            let startX = 0;
